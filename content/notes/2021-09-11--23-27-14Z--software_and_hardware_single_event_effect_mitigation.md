...
author = ["Ben Mezger"]
date = 2021-02-06T15:28:00+01:00
...
functions and behavior cite:Petersen2011SingleEventEfefctsInAerospace.
...
cite:Petersen2011SingleEventEfefctsInAerospace. With a variety of possible see,
...
cite:avizienis2004ConceptsOfSecureComputing. This paper aims at
...
cause hardware interference cite:avizienis2004ConceptsOfSecureComputing.
...
user-visible failure cite:Sorin2009FaultTolerantComputerArchitecture.
...
cite:Sorin2009FaultTolerantComputerArchitecture.
...
cite:Petersen2011SingleEventEfefctsInAerospace, however, the mitigation
...
cite:Petersen2011SingleEventEfefctsInAerospace.
...
cite:Sorin2009FaultTolerantComputerArchitecture categorizes permanent
...
software-level. The rest of the paper is organized as follows: section [2](#org-target--sec-background) gives a
brief background over the types of see and how they may affect the system, among
with fault metrics and types of errors, section [3](#org-target--sec-hw-mitigation) present some techniques for
mitigating single events at the circuit level, section [4](#org-target--sec-sw-mitigation) refers to
software-based approaches for single event mitigation. Finally, section [5](#org-target--sec-conclutions)
provides final conclusions.


## Background {#background}

<span class="org-target" id="org-target--sec-background"></span>
...
cite:Sorin2009FaultTolerantComputerArchitecture. This section overviews the
...
cite:Petersen2011SingleEventEfefctsInAerospace. These SEE is illustrated in
...
cite:Sorin2009FaultTolerantComputerArchitecture covers several important metrics
...
operation cite:Sorin2009FaultTolerantComputerArchitecture.
...
cite:Sorin2009FaultTolerantComputerArchitecture. Two primary approaches to error
...
system has been restored cite:Sorin2009FaultTolerantComputerArchitecture.


## Hardware Mitigation {#hardware-mitigation}

<span class="org-target" id="org-target--sec-hw-mitigation"></span>


### Soft errors {#soft-errors}

cite:reis2020CircutLevelDesignmethods explores four single transient mitigation
...
deviation cite:reis2020CircutLevelDesignmethods.
...
signal degradation cite:reis2020CircutLevelDesignmethods.
...
physical ground cite:reis2020CircutLevelDesignmethods.
...
penalty in complex gates cite:reis2020CircutLevelDesignmethods.


## Software Mitigation {#software-mitigation}

<span class="org-target" id="org-target--sec-sw-mitigation"></span>
...
requires more processing cite:Sorin2009FaultTolerantComputerArchitecture. The
...
instructions cite:Sorin2009FaultTolerantComputerArchitecture. The SWIFT scheme
by cite:reis2005SwitfSoftware} improved upon EDDI by combining with the control
flow checking and optimizing the performance by reducing the number of
comparison instructions.

cite:james2019applying provides a tool named coast, which provides an automated
...
cite:thati2018ComparisonOfDataFlowError.
...
error is reported cite:thati2018ComparisonOfDataFlowError.
...
comparing results cite:thati2018ComparisonOfDataFlowError.


## Conclusions {#conclusions}

<span class="org-target" id="org-target--sec-conclutions"></span>
