...
functions and behavior ([Petersen, n.d.](#org20b4827)).
...
([Petersen, n.d.](#org20b4827)). With a variety of possible see,
...
([Avizienis et al. 2004](#orgb3e0050)). This paper aims at
...
cause hardware interference ([Avizienis et al. 2004](#orgb3e0050)).
...
user-visible failure ([Sorin 2009](#org2c83e82)).
...
([Petersen, n.d.](#org20b4827)), however, the mitigation
...
([Sorin 2009](#org2c83e82)) categorizes permanent
...
software-level. The rest of the paper is organized as follows: section [2](#org0b909b4) gives a
brief background over the types of see and how they may affect the system, among
with fault metrics and types of errors, section [3](#org09e112b) present some techniques for
mitigating single events at the circuit level, section [4](#org2a70292) refers to
software-based approaches for single event mitigation. Finally, section [5](#org03785cd)
...
([Sorin 2009](#org2c83e82)). This section overviews the
...
([Petersen, n.d.](#org20b4827)). These SEE is illustrated in
...
([Sorin 2009](#org2c83e82)) covers several important metrics
...
operation ([Sorin 2009](#org2c83e82)).
...
([Sorin 2009](#org2c83e82)). Two primary approaches to error
...
system has been restored ([Sorin 2009](#org2c83e82)).
...
([Reis et al. 2020](#org62ca35e)) explores four single transient mitigation
...
deviation ([Reis et al. 2020](#org62ca35e)).
...
signal degradation ([Reis et al. 2020](#org62ca35e)).
...
physical ground ([Reis et al. 2020](#org62ca35e)).
...
penalty in complex gates ([Reis et al. 2020](#org62ca35e)).
...
requires more processing ([Sorin 2009](#org2c83e82)). The
...
instructions ([Sorin 2009](#org2c83e82)). The SWIFT scheme
by ([Reis et al. 2005](#orgb03e455))} improved upon EDDI by combining with the control
flow checking and optimizing the performance by reducing the number of
comparison instructions.

([James et al. 2019](#orgace9b6c)) provides a tool named coast, which provides an automated
...
error is reported ([Thati et al. 2018](#org7e45ac6)).
...
comparing results ([Thati et al. 2018](#org7e45ac6)).
...
<a id="orgb3e0050"></a>Avizienis, A., J. -. Laprie, B. Randell, and C. Landwehr. 2004. “Basic Concepts and Taxonomy of Dependable and Secure Computing.” _IEEE Transactions on Dependable and Secure Computing_ 1 (1):11–33. <https://doi.org/10.1109/TDSC.2004.2>.

<a id="org769affd"></a>Buchner, S. 2015. _Overview of Single Event Effects_. _Proc. 11th Int. School Effects Radiation Embedded Syst. Space Appl.(SERESSA)_.

<a id="orgace9b6c"></a>James, Benjamin, Heather Quinn, Michael Wirthlin, and Jeffrey Goeders. 2019. “Applying Compiler-Automated Software Fault Tolerance to Multiple Processor Platforms.” _IEEE Transactions on Nuclear Science_ 67 (1). IEEE:321–27.

<a id="org20b4827"></a>Petersen, Edward. n.d. _Single Event Effects in Aerospace / Edward Petersen._ _Single Event Effects in Aerospace_. Piscataway, N.J.? IEEE Press.

<a id="orgb03e455"></a>Reis, G. A., J. Chang, N. Vachharajani, R. Rangan, and D. I. August. 2005. “SWIFT: Software Implemented Fault Tolerance.” In _International Symposium on Code Generation and Optimization_, 243–54. <https://doi.org/10.1109/CGO.2005.34>.

<a id="org62ca35e"></a>Reis, R., C. Meinhardt, A. L. Zimpeck, L. H. Brendler, and L. Moraes. 2020. “Circuit Level Design Methods to Mitigate Soft Errors.” In _2020 IEEE Latin-American Test Symposium (LATS)_, 1–3. <https://doi.org/10.1109/LATS49555.2020.9093683>.

<a id="org2c83e82"></a>Sorin, Daniel J. 2009. _Fault Tolerant Computer Architecture_. Morgan and Claypool Publishers.

<a id="org7e45ac6"></a>Thati, Venu Babu, Jens Vankeirsbilck, Niels Penneman, Davy Pissoort, and Jeroen Boydens. 2018. “CDFEDT: Comparison of Data Flow Error Detection Techniques in Embedded Systems: An Empirical Study.” In _Proceedings of the 13th International Conference on Availability, Reliability and Security_. ARES 2018. New York, NY, USA: Association for Computing Machinery. <https://doi.org/10.1145/3230833.3230854>.
