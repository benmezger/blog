...
title = "C pointers"
author = ["Ben Mezger"]
date = 2021-02-12T23:50:00+01:00
slug = "c_pointers"
tags = ["C", "Programming"]
type = "notes"
draft = false
bookCollapseSection = true
summary = "Understanding pointers in C with examples."
+++
...
```text
&hostname is '0x7ffee966d288', *hostname is 's' and hostname is 'seds'
hostname address is '0x106595e42' and hostname[0] address is 0x106595e42

hostname + 1 address is '0x106595e43' and hostname[1] address is 0x106595e43
hostname + 2 address is '0x106595e44' and hostname[2] address is 0x106595e44
hostname + 3 address is '0x106595e45' and hostname[3] address is 0x106595e45
hostname + 4 address is '0x106595e46' and hostname[3] address is 0x106595e46
```
...
```text
hostname is 's', at address 0x1061d9f5a
hostname is 'e', at address 0x1061d9f5b
hostname is 'd', at address 0x1061d9f5c
hostname is 's', at address 0x1061d9f5d
Hostname is out of bound: '', at address 0x1061d9f5e
```
