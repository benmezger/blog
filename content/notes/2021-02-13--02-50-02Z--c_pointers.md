...
```text
&hostname is '0x7ffeee036a78', *hostname is 's' and hostname is 'seds'
hostname address is '0x101bcbe42' and hostname[0] address is 0x101bcbe42

hostname + 1 address is '0x101bcbe43' and hostname[1] address is 0x101bcbe43
hostname + 2 address is '0x101bcbe44' and hostname[2] address is 0x101bcbe44
hostname + 3 address is '0x101bcbe45' and hostname[3] address is 0x101bcbe45
hostname + 4 address is '0x101bcbe46' and hostname[3] address is 0x101bcbe46
```
...
```text
hostname is 's', at address 0x104c22f5a
hostname is 'e', at address 0x104c22f5b
hostname is 'd', at address 0x104c22f5c
hostname is 's', at address 0x104c22f5d
Hostname is out of bound: '', at address 0x104c22f5e
```