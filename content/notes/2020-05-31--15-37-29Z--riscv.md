...
title = "RISCV"
author = ["Ben Mezger"]
date = 2020-05-31T12:37:00+02:00
slug = "riscv"
tags = ["riscv", "cs", "architecture", "thesis"]
type = "notes"
draft = false
bookCollapseSection = true
summary = "Notes on RISC-V architecture, exceptions, and stack pointers."
+++
...
## Understanding RISCV stack pointer <span class="tag"><span class="riscv">riscv</span></span> {#understanding-riscv-stack-pointer}
...
will set `PC` to `base + 4 * cause`. For example Table has
...
## Privilege modes <span class="tag"><span class="os">os</span><span class="kernel">kernel</span></span> {#privilege-modes}
