...
functions and behavior ([Petersen, n.d.](#org3470e4e)).
...
([Petersen, n.d.](#org3470e4e)). With a variety of possible see,
...
([Avizienis et al. 2004](#org7f328a1)). This paper aims at
...
cause hardware interference ([Avizienis et al. 2004](#org7f328a1)).
...
user-visible failure ([Sorin 2009](#org5115f43)).
...
([Petersen, n.d.](#org3470e4e)), however, the mitigation
...
([Sorin 2009](#org5115f43)) categorizes permanent
...
software-level. The rest of the paper is organized as follows: section [2](#org5c46ab9) gives a
brief background over the types of see and how they may affect the system, among
with fault metrics and types of errors, section [3](#org3ec8a63) present some techniques for
mitigating single events at the circuit level, section [4](#orgc67504f) refers to
software-based approaches for single event mitigation. Finally, section [5](#org8b20b0e)
...
([Sorin 2009](#org5115f43)). This section overviews the
...
-  Types of Single Event Effect
    ...
    ([Petersen, n.d.](#org3470e4e)). These SEE is illustrated in
...
-  Fault tolerance metric
    ...
    ([Sorin 2009](#org5115f43)) covers several important metrics
...
-  Error detection
    ...
    operation ([Sorin 2009](#org5115f43)).
...
-  Error recovery
    ...
    ([Sorin 2009](#org5115f43)). Two primary approaches to error
    ...
    system has been restored ([Sorin 2009](#org5115f43)).
...
-  Soft errors
    ...
    ([Reis et al. 2020](#orgfd96125)) explores four single transient mitigation
    ...
    -  Schmitt Triggers
        ...
        deviation ([Reis et al. 2020](#orgfd96125)).
    ...
    -  Decoupling Cells
        ...
        signal degradation ([Reis et al. 2020](#orgfd96125)).
    ...
    -  Sleep Transistors
        ...
        physical ground ([Reis et al. 2020](#orgfd96125)).
    ...
    -  Transistor Reordering
        ...
        penalty in complex gates ([Reis et al. 2020](#orgfd96125)).
...
requires more processing ([Sorin 2009](#org5115f43)). The
...
-  Selective Code Duplication
    ...
    -  Error detection by duplicated instructions
        ...
        instructions ([Sorin 2009](#org5115f43)). The SWIFT scheme
        by ([Reis et al. 2005](#org955b095))} improved upon EDDI by combining with the control
        flow checking and optimizing the performance by reducing the number of
        comparison instructions.

        ([James et al. 2019](#org531c08e)) provides a tool named coast, which provides an automated
    ...
    -  Critical block duplication
        ...
        error is reported ([Thati et al. 2018](#orgce6ca47)).
...
-  Soft error detection using software redundancy
    ...
    comparing results ([Thati et al. 2018](#orgce6ca47)).
...
<a id="org7f328a1"></a>Avizienis, A., J. -. Laprie, B. Randell, and C. Landwehr. 2004. “Basic Concepts and Taxonomy of Dependable and Secure Computing.” _IEEE Transactions on Dependable and Secure Computing_ 1 (1):11–33. <https://doi.org/10.1109/TDSC.2004.2>.

<a id="org8d03579"></a>Buchner, S. 2015. _Overview of Single Event Effects_. _Proc. 11th Int. School Effects Radiation Embedded Syst. Space Appl.(SERESSA)_.

<a id="org531c08e"></a>James, Benjamin, Heather Quinn, Michael Wirthlin, and Jeffrey Goeders. 2019. “Applying Compiler-Automated Software Fault Tolerance to Multiple Processor Platforms.” _IEEE Transactions on Nuclear Science_ 67 (1). IEEE:321–27.

<a id="org3470e4e"></a>Petersen, Edward. n.d. _Single Event Effects in Aerospace / Edward Petersen._ _Single Event Effects in Aerospace_. Piscataway, N.J.? IEEE Press.

<a id="org955b095"></a>Reis, G. A., J. Chang, N. Vachharajani, R. Rangan, and D. I. August. 2005. “SWIFT: Software Implemented Fault Tolerance.” In _International Symposium on Code Generation and Optimization_, 243–54. <https://doi.org/10.1109/CGO.2005.34>.

<a id="orgfd96125"></a>Reis, R., C. Meinhardt, A. L. Zimpeck, L. H. Brendler, and L. Moraes. 2020. “Circuit Level Design Methods to Mitigate Soft Errors.” In _2020 IEEE Latin-American Test Symposium (LATS)_, 1–3. <https://doi.org/10.1109/LATS49555.2020.9093683>.

<a id="org5115f43"></a>Sorin, Daniel J. 2009. _Fault Tolerant Computer Architecture_. Morgan and Claypool Publishers.

<a id="orgce6ca47"></a>Thati, Venu Babu, Jens Vankeirsbilck, Niels Penneman, Davy Pissoort, and Jeroen Boydens. 2018. “CDFEDT: Comparison of Data Flow Error Detection Techniques in Embedded Systems: An Empirical Study.” In _Proceedings of the 13th International Conference on Availability, Reliability and Security_. ARES 2018. New York, NY, USA: Association for Computing Machinery. <https://doi.org/10.1145/3230833.3230854>.
