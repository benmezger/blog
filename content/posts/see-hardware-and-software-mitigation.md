...
functions and behavior ([Petersen, n.d.](#orge0bcb32)).
...
([Petersen, n.d.](#orge0bcb32)). With a variety of possible see,
...
([Avizienis et al. 2004](#org9e74f36)). This paper aims at
...
cause hardware interference ([Avizienis et al. 2004](#org9e74f36)).
...
user-visible failure ([Sorin 2009](#org0d1f5b4)).
...
([Petersen, n.d.](#orge0bcb32)), however, the mitigation
...
([Sorin 2009](#org0d1f5b4)) categorizes permanent
...
software-level. The rest of the paper is organized as follows: section [2](#org7f1ea1d) gives a
brief background over the types of see and how they may affect the system, among
with fault metrics and types of errors, section [3](#org4b09b6e) present some techniques for
mitigating single events at the circuit level, section [4](#org026b2c4) refers to
software-based approaches for single event mitigation. Finally, section [5](#orgefc35a8)
...
([Sorin 2009](#org0d1f5b4)). This section overviews the
...
([Petersen, n.d.](#orge0bcb32)). These SEE is illustrated in
...
([Sorin 2009](#org0d1f5b4)) covers several important metrics
...
operation ([Sorin 2009](#org0d1f5b4)).
...
([Sorin 2009](#org0d1f5b4)). Two primary approaches to error
...
system has been restored ([Sorin 2009](#org0d1f5b4)).
...
([Reis et al. 2020](#orgd32f056)) explores four single transient mitigation
...
- Schmitt Triggers
  ...
  deviation ([Reis et al. 2020](#orgd32f056)).
...
- Decoupling Cells
  ...
  signal degradation ([Reis et al. 2020](#orgd32f056)).
...
- Sleep Transistors
  ...
  physical ground ([Reis et al. 2020](#orgd32f056)).
...
- Transistor Reordering
  ...
  penalty in complex gates ([Reis et al. 2020](#orgd32f056)).
...
requires more processing ([Sorin 2009](#org0d1f5b4)). The
...
- Error detection by duplicated instructions
  ...
  instructions ([Sorin 2009](#org0d1f5b4)). The SWIFT scheme
  by ([Reis et al. 2005](#org13b925e))} improved upon EDDI by combining with the control
  flow checking and optimizing the performance by reducing the number of
  comparison instructions.

  ([James et al. 2019](#org8cdf72f)) provides a tool named coast, which provides an automated
...
- Critical block duplication
  ...
  error is reported ([Thati et al. 2018](#orgf8f977b)).
...
comparing results ([Thati et al. 2018](#orgf8f977b)).
...
<a id="org9e74f36"></a>Avizienis, A., J. -. Laprie, B. Randell, and C. Landwehr. 2004. “Basic Concepts and Taxonomy of Dependable and Secure Computing.” _IEEE Transactions on Dependable and Secure Computing_ 1 (1):11–33.

<a id="orgbb7d9f6"></a>Buchner, S. 2015. _Overview of Single Event Effects_. _Proc. 11th Int. School Effects Radiation Embedded Syst. Space Appl.(SERESSA)_.

<a id="org8cdf72f"></a>James, Benjamin, Heather Quinn, Michael Wirthlin, and Jeffrey Goeders. 2019. “Applying Compiler-Automated Software Fault Tolerance to Multiple Processor Platforms.” _IEEE Transactions on Nuclear Science_ 67 (1). IEEE:321–27.

<a id="orge0bcb32"></a>Petersen, Edward. n.d. _Single Event Effects in Aerospace / Edward Petersen._ _Single Event Effects in Aerospace_. Piscataway, N.J.? IEEE Press.

<a id="org13b925e"></a>Reis, G. A., J. Chang, N. Vachharajani, R. Rangan, and D. I. August. 2005. “SWIFT: Software Implemented Fault Tolerance.” In _International Symposium on Code Generation and Optimization_, 243–54.

<a id="orgd32f056"></a>Reis, R., C. Meinhardt, A. L. Zimpeck, L. H. Brendler, and L. Moraes. 2020. “Circuit Level Design Methods to Mitigate Soft Errors.” In _2020 IEEE Latin-American Test Symposium (LATS)_, 1–3.

<a id="org0d1f5b4"></a>Sorin, Daniel J. 2009. _Fault Tolerant Computer Architecture_. Morgan and Claypool Publishers.

<a id="orgf8f977b"></a>Thati, Venu Babu, Jens Vankeirsbilck, Niels Penneman, Davy Pissoort, and Jeroen Boydens. 2018. “CDFEDT: Comparison of Data Flow Error Detection Techniques in Embedded Systems: An Empirical Study.” In _Proceedings of the 13th International Conference on Availability, Reliability and Security_. ARES 2018. New York, NY, USA: Association for Computing Machinery. <https://doi.org/10.1145/3230833.3230854>.
